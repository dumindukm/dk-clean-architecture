    ...
    public static class GuardClauseExtensions
    {
        ...
        public static T Null<T>([JetBrainsNotNull] this IGuardClause guardClause, [NotNull, JetBrainsNotNull][ValidatedNotNull] T input, [JetBrainsNotNull] string parameterName, string? message = null)
        {
            if (input is null)
            {
                ...
                {
                    throw new DomainModelValidationException(message , new ArgumentNullException(parameterName));
                }

                throw new DomainModelValidationException(message ,new ArgumentNullException(message, (Exception?)null));
            }
